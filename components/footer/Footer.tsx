...
const Footer = () => {
  ...
  // Don't show footer on auth, dashboard, or embed pages
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-white font-bold text-lg">Doctor Directory</h3>
            <p className="text-sm leading-relaxed">
              Find board-certified orthopedic specialists for trusted second opinions. Make informed decisions about your healthcare.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/meet-your-surgeons" className="text-sm hover:text-white transition-colors">
                  Meet Your Surgeons
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © {currentYear} xprt2nd.com. All rights reserved.
            </p>
