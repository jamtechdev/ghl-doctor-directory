...
export default function AddDoctorPage() {
  ...
  const canGoNext = () => {
    ...
    if (step === 'basic') return formData.name && formData.doctorEmail && formData.doctorPassword;
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                {(imagePreview || uploadedImageUrl) && (
                  <div className="relative w-32 h-32 rounded-lg overflow-hidden border-2 border-gray-200 shadow-sm">
                    <img src={imagePreview || uploadedImageUrl} alt="Preview" className="w-full h-full object-contain object-top" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                  </div>
                )}
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="email" value={formData.doctorEmail} onChange={(e) => setFormData({ ...formData, doctorEmail: e.target.value })} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" placeholder="doctor@example.com" required />
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 mb-2">Login Password *</label>
                <input type="password" value={formData.doctorPassword} onChange={(e) => setFormData({ ...formData, doctorPassword: e.target.value })} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" placeholder="Minimum 6 characters" required minLength={6} />
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Create a new doctor profile for the directory</p>
            </div>
